...
Bibi.x({
    ...
    if ("string" == typeof X.Presets.Analytics["tracking-id"] && X.Presets.Analytics["tracking-id"]) {
        ...
        }(window, document, "script", "//www.google-analytics.com/analytics.js", "ga"), ga("create", X.Presets.Analytics["tracking-id"], "auto", {
            allowLinker: !0
        }), ga("require", "linker"), ga("linker:autoLink", function(e) {
